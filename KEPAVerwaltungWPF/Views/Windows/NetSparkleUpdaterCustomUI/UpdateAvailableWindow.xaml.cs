...
namespace KEPAVerwaltungWPF.Views.Windows.NetSparkleUpdaterCustomUI;
...
/// </summary>
public partial class UpdateAvailableWindow : BaseWindow, IUpdateAvailable, IReleaseNotesDisplayer,
    IUserRespondedToUpdateCheck
{
    ...
    public void UserRespondedToUpdateCheck(UpdateAvailableResult response)
    {
        if (!_wasResponseSent)
        {
            ...
            UserResponded?.Invoke(this,
                new UpdateResponseEventArgs(_dataContext?.UserResponse ?? UpdateAvailableResult.None, CurrentItem));
        }
    }
    ...
    private void ReleaseNotesBrowser_Loaded(object? sender, RoutedEventArgs e)
    {
        ...
        ReleaseNotesBrowser.Loaded -= ReleaseNotesBrowser_Loaded;
        ReleaseNotesBrowser.Dispatcher.Invoke(() => { ReleaseNotesBrowser.NavigateToString("about:blank"); });
    }
