...
public class DownloadProgressWindowViewModel : ChangeNotifier
{
    ...
    public string UserReadableDownloadProgress
    {
        ...
        set
        {
            _userReadableDownloadProgress = value;
            NotifyPropertyChanged();
        }
    }
    ...
    {
        get => _isDownloading || _didDownloadFail ? "Abbrechen" : _actionButtonTitle;
        set
        {
